...
public class ReporteController {
    ...
    @GetMapping
    public String homeReportes() {
        return "Endpoint de reportes funcionando";
    }
    ...
    public ResponseEntity<Reporte> crearReporte(
        ...
        Reporte nuevoReporte = reporteService.crearReporteCompleto(
                reporte,
    ...
    public List<Reporte> listarPendientes(@PathVariable Long empresaId) {
        return reporteService.obtenerReportesPorEmpresaYEstado(
                empresaId,
                "Pendiente"
        );
    }
